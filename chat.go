...
var appId, _ = os.LookupEnv("PUSHER_APP_ID")
var appKey, _ = os.LookupEnv("PUSHER_APP_KEY")
var appSecret, _ = os.LookupEnv("PUSHER_APP_SECRET")
var appCluster, _ = os.LookupEnv("PUSHER_APP_CLUSTER")
